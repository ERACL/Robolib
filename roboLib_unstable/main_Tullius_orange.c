...
task main() {
  ...
  moveTo(-100, 0);
	moveTo(-660, -400);
	moveTo(-660, 400);
	moveTo_backward(-660, -700);
	moveTo_backward(-300, -1160);
	moveTo_backward(-300, -1450);
	...
	moveTo(-550, -1300);
	moveTo_backward(-1125, -1100);
	moveTo(-825, -1200);
	moveTo_backward(-1400, -1200);
	moveTo(-400, -100);
	moveTo(-600, 600);
	while (getMovementState() != NOMVT) {wait1Msec(20);}
	__position.orientation = PI/2;

	moveTo_backward(-600, 200);
	moveTo_backward(-1100, 200);
	while (getMovementState() != NOMVT) {wait1Msec(20);}

	stopTask(avoidObstacles);
	moveTo_backward(-1100, 800);
